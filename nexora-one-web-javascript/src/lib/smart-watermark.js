 ...
 *  水印DOM id
 */
const WATER_MARK_DOM_ID = 'nexora_one_water_mark';
let nexoraOneWaterMarkIntervalId = null;
...
const watermark = {
    ...
    set: function (id, str) {
        ...
        //每隔1分钟检查一次水印
        nexoraOneWaterMarkIntervalId = setInterval(() => {
            setWatermark(id, str);
        }, 60000);
    ...
    clear: function () {
        ...
        if (nexoraOneWaterMarkIntervalId) {
            clearInterval(nexoraOneWaterMarkIntervalId);
            nexoraOneWaterMarkIntervalId = null;
        }
    },
};

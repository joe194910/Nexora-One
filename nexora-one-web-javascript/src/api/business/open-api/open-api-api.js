...
export const openApiApi = {
  ...
  createVersion: (param) => postRequest('/open-api/manage/version/create', param),
  versionList: (openApiId) => getRequest(`/open-api/manage/version/list/${openApiId}`),
  versionDetail: (openApiId, versionId) => getRequest(`/open-api/manage/version/detail/${openApiId}/${versionId}`),
  ...
  revokePermission: (permissionId) => postRequest(`/open-api/portal/permission/revoke/${permissionId}`),
  ...
  publishReviewDetail: (reviewId) => getRequest(`/open-api/portal/publish/review/detail/${reviewId}`),

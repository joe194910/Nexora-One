...
import com.nexoraone.base.module.support.operatelog.OperateLogDao;
...
public abstract class OperateLogAspect {
    ...
    private static final String POINT_CUT = "@within(com.nexoraone.base.module.support.operatelog.annotation.OperateLog) || @annotation(com.nexoraone.base.module.support.operatelog.annotation.OperateLog)";
